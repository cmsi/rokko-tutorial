...
\begin{frame}
  \titlepage
  \noindent {\footnotesize PDF file: \url{http://sf.net/projects/rokko-tutorial/files/tutorial-en.pdf}} \\
...
\begin{frame}
  \frametitle{Contents of the tutorial}
  \begin{itemize}
 ...
 programs
  ...
  \item Appendix: Installing Rokko
%  \item Lecture/hands-on: Structure of sequential dense solvers / Running sample
  \end{itemize}
\end{frame}
