...
\begin{frame}
  ...
  \noindent {\footnotesize LaTeX source: \url{https://github.com/cmsi/rokko-tutorial/tree/wakate}}
\end{frame}
...
\begin{frame}
  ...
  \item For dense matrix (MPI)
    ...
    \end{itemize}
  %% \item For sparse matrix (serial MPI)
  %%   \begin{itemize}
  %%     \item Anasazi $>$ SLEPc
  %%   \end{itemize}
  \end{itemize}
...
\dirtree{%
 ...
 $\cdots$ for dense matrix ({serial}\&MPI).
 ...
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/sample_c/dense}{dense} $\cdots$ for dense matrix ({serial}\&MPI).
 .3
 ...
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/sample_fortran/dense}{dense} $\cdots$ for dense matrix ({serial}\&MPI).
...
\begin{frame}[c,fragile]
  \frametitle{LAPACK, ScaLAPACK, Rokko for Fortran}
  \begin{center}
...
%%   \item Heisenberg model (serial) \RokkoFilename{sample/dense/heisenberg.cpp}
%% \begin{lstlisting}[style=shstyle]
...
%% \end{lstlisting}
%%   \item XYZ model (serial) \RokkoFilename{sample/dense/xyz.cpp}
%% \begin{lstlisting}[style=shstyle]
...
\begin{frame}[c,fragile]
 ...
 \begin{itemize}
  ...
  \item Sample of LAPACK, ScaLAPACK
  \item Sample of Rokko's integrated interface for EigenExa, ScaLAPACK, etc.
  \end{itemize}
