...
\begin{frame}
  ...
  \noindent {\footnotesize LaTeX source: \url{https://github.com/cmsi/rokko-tutorial/wakate}}
\end{frame}
...
\begin{frame}
  ...
  \item Less overhead wrappers by using virtual functions and templates
...
./sample/dense/dsyev
\end{lstlisting}
  \item Using serial dense solvers thorugh Rokko
  \begin{itemize}
