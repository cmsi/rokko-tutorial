...
%    \item 本山裕一 (東大院工 $\Rightarrow $ 物性研) \ \href{mailto:y-motoyama@issp.u-tokyo.ac.jp}{y-motoyama@issp.u-tokyo.ac.jp}
    \end{itemize}
  \item 主催
    \begin{itemize}
...
\begin{frame}
  ...
  \item 座学: 密行列向け逐次・MPI並列ソルバの基本概念
  \item 座学: 疎行列向けソルバの基本概念
  \item 実習: サンプルの実行
  \item 実習：TITPACK2へのRokko組み込み実習
  \item 実習: アプリケーションからのRokkoの利用
  \item（付録: Rokkoのインストール）
...
\dirtree{%
 .1 \href{https://github.com/t-sakashita/rokko/tree/develop}{/}.
 .2
 ...
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/sample/dense}{dense} $\cdots$ 密行列用.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/sample/sparse}{sparse} $\cdots$ 疎行列用.
 .2 \href{https://github.com/t-sakashita/rokko/tree/develop/sample_c}{sample\_c} $\cdots$ Cによるサンプルプログラム.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/sample_c/dense}{dense} $\cdots$ 密行列用.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/sample_c/sparse}{sparse} $\cdots$ 疎行列用.
 .2 \href{https://github.com/t-sakashita/rokko/tree/develop/sample_fortran}{sample\_fortran}
 $\cdots$ Fortranによるサンプルプログラム.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/sample_fortran/dense}{dense} $\cdots$ 密行列用.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/sample_fortran/sparse}{sparse} $\cdots$ 疎行列用.
 .2
 \href{https://github.com/t-sakashita/rokko/tree/develop/test}{test}
 $\cdots$ ctest用（インストール成否の確認）.
 .2 3rd-party $\cdots$ 固有値ソルバ.
 .2 \href{https://github.com/t-sakashita/rokko/tree/develop/tutorial}{tutorial} $\cdots$ チュートリアル用.
 .3
 \href{https://github.com/t-sakashita/rokko/tree/develop/tutorial/titpack}{titpack}
 $\cdots$ 厳密対角化パッケージによるチュートリアル.
}
...
\begin{frame}[c,fragile]
  \frametitle{rokko::serial\_dense\_solverクラス(密行列、逐次版)}
  \begin{itemize}
    %\setlength{\itemsep}{1em}
  \item 初期化
\begin{lstlisting}
...
rokko::localized_matrix<matrix_col_major> evecs(dim, dim, g, solver);
...
\begin{frame}[c,fragile]
  \frametitle{rokko::parallel\_dense\_solverクラス(密行列、MPI並列版)}
  \begin{itemize}
    %\setlength{\itemsep}{1em}
  \item 初期化
\begin{lstlisting}
...
\item 非ゼロ成分に対する列添字$= [1, 2, 4, 1, 4, 3]$
\item 非ゼロ行列成分$= [7, 9, 6, 4, 5, 7]$
\end{itemize}
\end{rei}
...
\begin{frame}[c,fragile]
rokko::distributed\_mfreeを継承し、 multiply(const double* x, double* y)関数を持つクラスを定義する。
\begin{lstlisting}
...
./sample/dense/dsyev
\end{lstlisting}
  \item 逐次密行列solverを使う \href{https://github.com/t-sakashita/rokko/blob/master/sample/dense/frank_dense.cpp}{sample/dense/frank.cpp}
\begin{lstlisting}[style=shstyle]
./sample/dense/frank lapack 5
\end{lstlisting}
  \item 並列密行列ソルバを使う \href{https://github.com/t-sakashita/rokko/blob/master/sample/dense/frank_dense_mpi.cpp}{sample/dense/frank\_mpi.cpp}
\begin{lstlisting}[style=shstyle]
mpirun -np 4 ./sample/dense/frank_mpi elpa 5
\end{lstlisting}
  \end{itemize}
\end{frame}
...
\begin{frame}[c,fragile]
  ...
  \begin{itemize}
    %\setlength{\itemsep}{1em}
  \item Heisenberg模型(MPI) \href{https://github.com/t-sakashita/rokko/blob/master/sample/dense/heisenberg_mpi.cpp}{sample/dense/heisenberg\_mpi.cpp}
\begin{lstlisting}[style=shstyle]
mpirun -np 4 ./sample/dense/heisenberg_mpi elpa
\end{lstlisting}
  \item XYZ模型(逐次) \href{https://github.com/t-sakashita/rokko/blob/develop/sample/dense/xyz_dense.cpp}{sample/dense/xyz.cpp}
\begin{lstlisting}[style=shstyle]
...
\begin{lstlisting}
mpirun -np 4 ./sample/dense/xyz_mpi elpa $HOME/rokko-0.1/test/input_data/xyz_1hexagon.ip
\end{lstlisting}
  \end{itemize}
\end{frame}
...
\dirtree{%
 ...
 \href{https://github.com/t-sakashita/rokko/tree/develop/tutorial/titpack}{titpack}.
 .3
 \href{https://github.com/t-sakashita/rokko/tree/develop/tutorial/titpack/00_original}{00\_original} $\cdots$ Fortran版.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/tutorial/titpack/01_lapack}{01\_lapack} $\cdots$ Fortran版.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/tutorial/titpack/01_lapack_cxx}{01\_lapack\_cxx} $\cdots$ Fortran版.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/tutorial/titpack/02_refactored_cxx}{02\_refactored\_cxx} $\cdots$ Fortran版.
 .3 \href{https://github.com/t-sakashita/rokko/tree/develop/tutorial/titpack/03_rokko_cxx}{03\_rokko\_cxx} $\cdots$ Fortran版.
}
\end{frame}
