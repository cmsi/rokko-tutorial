...
\lstset{language=c++,basicstyle=\ttfamily\tiny,showspaces=false,rulecolor=\color[cmyk]{0, 0.29,0.84,0}}
...
\begin{frame}
  ...
  \item ソースコード
    ...
    \item 参考: バージョン管理web講習会 {\tiny \url{http://www.cms-initiative.jp/ja/research-support/develop-support/how-to-publish/develop-apps/manage-version}}
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}[c,fragile]
  ...
  \begin{itemize}
  \item \href{https://github.com/t-sakashita/rokko/blob/develop/rokko/grid.hpp}{rokko/grid.hpp}
\begin{lstlisting}
namespace rokko {
...
\begin{frame}[c,fragile]
  ...
  \begin{itemize}
  \item \href{https://github.com/t-sakashita/rokko/blob/develop/rokko/localized_matrix.hpp}{rokko/localized\_matrix.hpp}
\begin{lstlisting}
namespace rokko {
...
\begin{frame}[c,fragile]
  ...
  \begin{itemize}
  \item \href{https://github.com/t-sakashita/rokko/blob/develop/test/localized_matrix.cpp}{test/localized\_matrix.cpp}
\begin{lstlisting}
int dim = 3;
...
\begin{frame}[c,fragile]
  ...
  \begin{itemize}
  \item \href{https://github.com/t-sakashita/rokko/blob/develop/rokko/distributed_matrix.hpp}{rokko/distributed\_matrix.hpp}
\begin{lstlisting}
namespace rokko {
template<typename MATRIX_MAJOR = rokko::matrix_row_major>
...
rokko::distributed_matrix<rokko::matrix_col_major> evecs(dim, dim, g, solver);
solver.diagonalize(mat, evals, evecs);
\end{lstlisting}
  \item 登録されているソルバの一覧
\begin{lstlisting}
std::vector<std::string> names = rokko::solver_factory::solverls_names();
\end{lstlisting}
  \end{itemize}
\end{frame}
...
\begin{lstlisting}
source /opt/nano/alps/env.sh
mkdir $HOME/opt
ln -s /opt/nano/alps/rokko $HOME/opt
\end{lstlisting}
  \item ソースコードのダウンロード・展開
\begin{lstlisting}
cd $HOME
wget --no-check-certificate https://github.com/t-sakashita/rokko/archive/develop.zip
unzip develop
\end{lstlisting}
  \item CMake
\begin{lstlisting}
mkdir rokko-build
cd rokko-build
cmake -DCMAKE_C_COMPILER=icc -DCMAKE_CXX_COMPILER=icpc -DCMAKE_Fortran_COMPILER=ifort $HOME/rokko-develop
\end{lstlisting}
  \item Make, テスト
\begin{lstlisting}
make
